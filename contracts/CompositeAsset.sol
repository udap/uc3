...
contract CompositeAsset is StandardAsset {
  ...
  function CompositeAsset(address _issuer,address _owner, uint _id, bytes32 _nsi, bool _transferrable,string data,bytes32 _mdHash, address[] _assets)
    StandardAsset(_issuer,_owner, _id, _nsi, _transferrable,data,_mdHash) public {
